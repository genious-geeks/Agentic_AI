...
index = VectorStoreIndex(nodes=nodes, storage_context=storage_context, embed_model=OllamaEmbedder(model='nomic-embed-text:latest'))

retriever = VectorIndexRetriever(index, embed_model=OllamaEmbedder(model='nomic-embed-text:latest'))
